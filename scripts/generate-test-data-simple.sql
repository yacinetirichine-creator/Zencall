-- Generate Test Data for Admin System (Simple Version)
-- 
-- IMPORTANT: Replace 'YOUR-USER-UUID-HERE' with your actual user UUID
-- To get your UUID: Go to Supabase Dashboard → Authentication → Users → Copy your user ID
--
...
DECLARE
  ...
  j INTEGER;
BEGIN
  -- Automatically get the most recent user
  ...
  IF v_test_user_id IS NULL THEN
    RAISE EXCEPTION 'No users found in auth.users. Please create a user account first by registering at /register, then re-run this script.';
  END IF;
